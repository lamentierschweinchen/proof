...
**No backstage bleed.** The writer's drafting process belongs in the workspace, not the published essay. *"The framing I had drafted"* is the writing pulling back the curtain to show its working. *"The framing I had in mind"* preserves the same self-correction without the literal process word. Allusions to *"what I almost said"* or *"what I considered and rejected"* are useful only when they illuminate the published claim — not as a tic of writerly humility. Bleed also includes narrating the *production of the criticism itself* — e.g. *"it turns out we reached the same reference independently,"* which pulls the curtain on how the two critics' pieces were made. The convergence can be the subject; the behind-the-scenes phrasing (*"it turns out," "independently,"* offered as a discovered coordination-fact) is the bleed. Flag the phrasing; leave the claim.
